...
for i in range(3,106):
    ...
    dep_1_s_dob = worksheet.cell(row=i, column=70).value
    ...
    dep_2_s_dob = worksheet.cell(row=i, column=89).value
    ...
    dep_3_s_dob = worksheet.cell(row=i, column=108).value
    ...
    dep_4_s_dob = worksheet.cell(row=i, column=127).value
    ...
    dep_5_s_dob = worksheet.cell(row=i, column=146).value
    date_string = str(dep_5_s_dob)
    dep_5_dob = datetime_string.split(' ')[0]
    ...
    dep_6_s_dob = worksheet.cell(row=i, column=165).value
    ...
    dep_7_s_dob = worksheet.cell(row=i, column=184).value
    ...
    dep_8_s_dob = worksheet.cell(row=i, column=203).value
    ...
    Dep_first_name_list = [dep_1_firstname,dep_2_firstname,dep_3_firstname,dep_4_firstname, dep_5_firstname, dep_6_firstname, dep_7_firstname, dep_8_firstname]
    row, col = 3, 71
    for data_1 in Dep_first_name_list:
        while ws2.cell(row=row, column=col).value:
            row += 1
        print(row)
        ws2.cell(row=row, column=71).value = data_1
        row += 1

    Dep_last_name_list = [dep_1_lastname,dep_2_lastname,dep_3_lastname,dep_4_lastname,dep_5_lastname, dep_6_lastname, dep_7_lastname, dep_8_lastname]
    row, col = 3, 73
    for data_2 in Dep_last_name_list:
        while ws2.cell(row=row, column=col).value:
            row += 1
        ws2.cell(row=row, column=73).value = data_2
        row += 1

    Dep_dob_list = [dep_1_s_dob, dep_2_s_dob, dep_3_s_dob, dep_4_s_dob, dep_5_s_dob, dep_6_s_dob, dep_7_s_dob, dep_8_s_dob]
    row, col = 3, 76
    for data_3 in Dep_dob_list:
        while ws2.cell(row=row, column=col).value:
            row += 1
        ws2.cell(row=row, column=76).value = data_3
        row += 1
        break
