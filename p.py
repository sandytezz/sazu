...
for i in range(3,106):
    ...
    dep_1_f = worksheet.cell(row=i, column=65).value
    dep_2_f = worksheet.cell(row=i, column=84).value
    dep_3_f = worksheet.cell(row=i, column=103).value
    dep_4_f = worksheet.cell(row=i, column=122).value
    dep_5_f = worksheet.cell(row=i, column=141).value
    dep_6_f = worksheet.cell(row=i, column=160).value
    dep_7_f = worksheet.cell(row=i, column=179).value
    dep_8_f = worksheet.cell(row=i, column=198).value
    ...
    dep_f = [dep_1_f, dep_2_f, dep_3_f, dep_4_f, dep_5_f, dep_6_f, dep_7_f, dep_8_f]
    row, col = 3, 71
